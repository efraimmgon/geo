...
def populate():
	...
	objs = [
		...
		'link': 'http://www.planalto.gov.br/ccivil_03/decreto-lei/Del3689Compilado.htm',
		'tags': [nacional]
		},
		{
		'name': 'CPM',
		'description': 'Código Penal Militar',
		'link': 'http://www.planalto.gov.br/ccivil_03/decreto-lei/Del1001Compilado.htm',
		...
		'link': 'http://www.planalto.gov.br/ccivil_03/LEIS/L9503.htm',
		'tags': [nacional]
		},
		{
		'name': 'Vade Mécum 01',
		'description': 'Guarda de Honra',
		'link': 'http://www.pm.mt.gov.br/Legislacao/MILITAR/05.pdf',
		'tags': [cerimonial_militar]
		},
		{
		'name': 'Vade Mécum 02',
		'description': 'Passagem de Comando',
		'link': 'http://www.pm.mt.gov.br/Legislacao/MILITAR/06.pdf',
		'tags': [cerimonial_militar]
		},
		{
		'name': 'Vade Mécum 03',
		'description': 'Recepção de Autoridades',
		'link': 'http://www.pm.mt.gov.br/Legislacao/MILITAR/07.pdf',
		'tags': [cerimonial_militar]
		},
		{
		'name': 'Vade Mécum 09',
		'description': 'Honras Fúnebres',
		'link': 'http://www.pm.mt.gov.br/Legislacao/MILITAR/08.pdf',
		'tags': [cerimonial_militar]
		},
		{
		'name': 'RISG',
		'description': 'Regulamento Interno e dos Serviços Gerais',
		'link': 'http://www.pm.mt.gov.br/Legislacao/MILITAR/04.pdf',
		'tags': [militar]
		},
		{
		'name': 'R-200',
		'description': 'Regulamento para as Polícias e Bombeiros Militares',
		'link': 'http://www.pm.mt.gov.br/Legislacao/MILITAR/03.pdf',
		'tags': [nacional, militar]
		},
		{
		'name': 'CC',
		...
		'link': 'http://www.planalto.gov.br/ccivil_03/leis/L5869compilada.htm',
		'tags': [nacional]
		},
		{
		'name': 'Estatudo PMMT',
		'description': 'Estatuto dos Militares do Estado de Mato Grosso',
		'link': 'http://www.gestao.mt.gov.br/download.php?Op=legislacao&arquivo=LC_555-2014-107.pdf',
		...
		'link': 'http://www.pm.mt.gov.br/Legislacao/MILITAR%20ESTADUAL/05.pdf',
		'tags': [estadual, militar]
		},
		{
		...
		'link': 'http://www.pm.mt.gov.br/Legislacao/MILITAR%20ESTADUAL/06.pdf',
		'tags': [estadual, militar]
		},
		{
		...
		'link': 'http://www.pm.mt.gov.br/Legislacao/MILITAR%20ESTADUAL/21.pdf',
		'tags': [estadual, militar]
		},
		{
		'name': 'RDPMMT',
		'description': 'Decreto nº 1.329 de 21 de Abril de 1978: aprova o ' +
			...
			'Mato Grosso',
		'link': 'http://www.pm.mt.gov.br/Legislacao/MILITAR%20ESTADUAL/24.pdf',
		'tags': [estadual, militar]
		},
		{
		...
		'link': 'http://www.pm.mt.gov.br/Legislacao/MILITAR%20ESTADUAL/35.pdf',
		'tags': [militar]
		},
		{
		'name': 'Manual de IPM',
		...
		'link': 'http://www.pm.mt.gov.br/Legislacao/MILITAR%20ESTADUAL/33.pdf',
		'tags': [militar]
		},
		{
		'name': 'Manual de Deserção',
		'description': 'Manual de Deserção - Antigo',
		'link': 'http://www.pm.mt.gov.br/Legislacao/MILITAR%20ESTADUAL/32.pdf',
		'tags': [militar]
		}
	]
...
def add_externalsource(name, description, link, tags):
